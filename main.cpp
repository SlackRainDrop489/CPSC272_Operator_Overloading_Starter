...
int main() {
    ...
    // Create another ServiceAccount with identifier "1234", same password, and random balance
    ServiceAccount c("1234", "password", rand());

    // Create another ServiceAccount with identifier "1893", same password, and random balance
    ServiceAccount d("1893", "password", rand());
    ...
    if (c < d)
        std::cout << "Account c is smaller than d" << std::endl;
    else
        std::cout << "Account d is smaller than c" << std::endl;
